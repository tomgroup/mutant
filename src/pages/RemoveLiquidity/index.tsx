...
import { Currency, currencyEquals, CETH, Percent, WETH, ROUTER_ADDRESS } from '@mutantswap/sdk'
      ...
      <>
        <RowBetween>
          <Text color={theme.text2} fontWeight={500} fontSize={16}>
            {/*TODO: Translate using i18n*/}
            {'MSLP ' + currencyA?.symbol + '/' + currencyB?.symbol} Burned
          </Text>
          <RowFixed>
