import { CurrencyAmount, JSBI, Token, Trade } from '@mutantswap/sdk'
...
import { ButtonError, ButtonLight, ButtonPrimary, ButtonPrimaryBlue, ButtonConfirmed } from '../../components/Button'
...
import handAsset from '../../assets/images/hand.png'
import mutantCoinBouncing from '../../assets/images/bouncing-mutant-coin.gif'
        ...
        <SwapContainer>
          <AppBody>
            ...
            <Wrapper id="swap-page">
              ...
              <BottomGrouping>
                {!account ? (
                  <ButtonPrimaryBlue onClick={toggleWalletModal}>{t('swapPage.connectWallet')}</ButtonPrimaryBlue>
                ) : showWrap ? (
