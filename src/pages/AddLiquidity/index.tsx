...
import { Currency, currencyEquals, CETH, TokenAmount, WETH, ROUTER_ADDRESS } from '@mutantswap/sdk'
...
import { ButtonError, ButtonLight, ButtonPrimary, ButtonPrimaryBlue } from '../../components/Button'
      ...
      <AppBody>
        ...
        <Wrapper>
          ...
          <AutoColumn gap="20px">
            ...
            {!account ? (
              <ButtonPrimaryBlue onClick={toggleWalletModal}>{t('addLiquidity.connectWallet')}</ButtonPrimaryBlue>
            ) : (
              <AutoColumn gap={'md'}>
