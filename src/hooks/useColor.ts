...
import { Token } from '@mutantswap/sdk'
...
async function getColorFromToken(token: Token): Promise<string | null> {
  ...
  const path = `https://raw.githubusercontent.com/mutantswap/tokens/main/assets/${token.address}/logo.png` //TODO: update mainnet based URL
