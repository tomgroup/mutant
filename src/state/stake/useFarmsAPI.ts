...
export function useFarmsAPI(): StakingMCOINFarms[] {
  ...
  result.current = lpAddresses.map((_, index) => {
    ...
    return {
      ...
      noMCOINRewards: activeFarms[index].noMCOINRewards,
