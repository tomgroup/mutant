...
import { ChefVersions, STAKING, StakingMCOIN, StakingMCOINStakedAmounts } from './stake-constants'
...
export function useFarmContractsForVersion(chefVersion: ChefVersions): StakingMCOINStakedAmounts[] {
...
function getLPAddresses(activeFarms: StakingMCOIN[], chefVersion: ChefVersions) {
