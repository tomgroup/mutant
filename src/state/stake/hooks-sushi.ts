import { ChainId, CurrencyAmount, JSBI, Token } from '@mutantswap/sdk'
...
export const MASTERCHEF_ADDRESS_V1: AddressMap = {
  ...
  [ChainId.AURORA]: '0x6FF09C2274d6Fc4826136dA9AC7b9F970086577F' //TODO change MasterChefV1 address
}

export const MASTERCHEF_ADDRESS_V2: AddressMap = {
  [ChainId.POLYGON]: '0x43A1dD21a5237C6F5eEC94747C28aa3f5C8fa1c7',
  [ChainId.AURORA]: '0xd616ab1aa6f629cE23476BA6133F47dC58Ddbfa9' //TODO change MasterChefV2 address
}
